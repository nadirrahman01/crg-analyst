...
// Log that the file loaded successfully
console.log('app.js loaded successfully');
console.log('addImages function defined:', typeof addImages);
console.log('createDocument function defined:', typeof createDocument);
